...
\end{longtabu}
\hypertarget{index_autotoc_md5}{}\doxysection{Hybrid Parallelized Variables}\label{index_autotoc_md5}
...
In situations where there is no need for thread-\/reduction, the base class \mbox{\hyperlink{classDistributed}{Distributed}} is an adequate solution. 