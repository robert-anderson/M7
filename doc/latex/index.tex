\label{index_md__home_teamcity_TeamCity_buildAgent_work_5343cdffda4690e5_README}%
\Hypertarget{index_md__home_teamcity_TeamCity_buildAgent_work_5343cdffda4690e5_README}%
Many-\/body Stochastic Expectation Value Estimation Networks (M7) is a stochastic electronic structure program written in C++ which primarily implements the Full Configuration Interaction Quantum Monte Carlo (F\+C\+I\+Q\+MC) method.\hypertarget{index_autotoc_md1}{}\doxysection{Installation}\label{index_autotoc_md1}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{git clone https://github.com/robert-\/anderson/M7.git}
\end{DoxyCode}
...
\DoxyCodeLine{cmake ..}
\DoxyCodeLine{make -\/j TARGET}
\end{DoxyCode}


Where T\+A\+R\+G\+ET is either debug, release or unittest. The binary will then appear at either src/debug, src/release, or test/unittest.\hypertarget{index_autotoc_md2}{}\doxysection{Usage}\label{index_autotoc_md2}
