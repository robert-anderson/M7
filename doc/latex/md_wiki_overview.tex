...
\end{longtabu}
at the end of this loop over occupied determinants, the walker list reflects only the update to the approximate wavefunction due to the diagonal part of the shifted \mbox{\hyperlink{classHamiltonian}{Hamiltonian}}.\hypertarget{md_wiki_overview_autotoc_md6}{}\doxysubsection{Communication}\label{md_wiki_overview_autotoc_md6}
...
\end{longtabu}
\hypertarget{md_wiki_overview_autotoc_md7}{}\doxysubsection{Annihilation}\label{md_wiki_overview_autotoc_md7}
