...
{\bfseries{walker list\+:}} $\Cin+\ddeathn$, {\bfseries{send buffer\+:}} $\dspawnn$, {\bfseries{receive buffer\+:}} $0$ \hypertarget{md_wiki_overview_autotoc_md6}{}\doxysubsection{Communication}\label{md_wiki_overview_autotoc_md6}
