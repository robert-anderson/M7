...
TEST(IntegralArray2e, SymNone_real) {
    ...
    if (mpi::on_node_i_am_root()) {
        ...
        // D
        ASSERT_TRUE(ints.set_(1, 0, 3, 2, v[1]));
        // R
        ASSERT_TRUE(ints.set_(0, 1, 3, 2, v[2]));
        // DR
        ASSERT_TRUE(ints.set_(1, 0, 2, 3, v[3]));
        // H
        ASSERT_TRUE(ints.set_(2, 3, 0, 1, v[4]));
        // DH
        ASSERT_TRUE(ints.set_(3, 2, 1, 0, v[5]));
        // HR
        ASSERT_TRUE(ints.set_(3, 2, 0, 1, v[6]));
        // DRH
...
TEST(IntegralArray2e, SymD_real) {
    ...
    if (mpi::on_node_i_am_root()) {
        ...
        ASSERT_TRUE(ints.set_(0, 1, 2, 3, v[0]));
        // R
        ASSERT_TRUE(ints.set_(0, 1, 3, 2, v[1]));
        // H
        ASSERT_TRUE(ints.set_(2, 3, 0, 1, v[2]));
        // HR
