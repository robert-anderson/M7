...
TEST(UtilConvert, FloatVectorToString) {
    ...
    ASSERT_EQ(convert::to_string(v, {true, 6}), "[9.090909e-02, -1.234000e+00, 5.300000e+00, 3.010000e+00, 1.428571e-01]");
    ASSERT_EQ(convert::to_string(v, {true, 1}), "[9.1e-02, -1.2e+00, 5.3e+00, 3.0e+00, 1.4e-01]");
    ASSERT_EQ(convert::to_string(v, {true, 0}), "[9e-02, -1e+00, 5e+00, 3e+00, 1e-01]");
}