...
namespace sparse_matrix_examples {
    ...
    sparse::dynamic::Matrix<double> rect_double(
            const uint_t &nrow, const uint_t &ncol, const uint_t &nnonzero_per_row);
    sparse::dynamic::Matrix<std::complex<double>> rect_double_complex(
            const uint_t &nrow, const uint_t &ncol, const uint_t &nnonzero_per_row);
