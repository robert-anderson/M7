...
TEST(BufferedFields, FrmBosOnv){
    defs::uintv_t frm_inds = {0, 2, 4, 5, 7};
    defs::uintv_t bos_inds = {3, 1, 2, 4, 9};
...
TEST(BufferedFields, FrmBosXonv){
    defs::uintv_t ket_frm_inds = {0, 2, 4, 5, 7};
    defs::uintv_t ket_bos_inds = {3, 1, 2, 4, 9};
    defs::uintv_t bra_frm_inds = {1, 2, 3, 7};
    defs::uintv_t bra_bos_inds = {2, 4, 9, 3, 1};
    const sys::frm::Basis frm_basis(4);
