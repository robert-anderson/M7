...
TEST(Dense, ComplexHermEig) {
     ...
     */
    mat.set_row(0, {{4,0}, {-1,0}, {-5,2}, {-2,-5}});
    mat.set_row(1, {{-1,0}, {0,0}, {-3,-1}, {-3,2}});
    mat.set_row(2, {{-5,-2}, {-3,1}, {-4,0}, {-1,2}});
    mat.set_row(3, {{-2,5}, {-3,-2}, {-1,-2}, {2,0}});
     ...
     */
    dense::SquareMatrix<T> evecs(n);
    evecs.set_row(0, {3.58482045e-01, 5.10924587e-01, 2.72230923e-01, -7.32350336e-01});
    evecs.set_row(1, {4.23494924e-01, -3.15364004e-01,  1.79580298e-01, 5.40389092e-02});
    evecs.set_row(2, {7.86848083e-01,  2.34349354e-02, -2.92244286e-01, 2.92874123e-01});
    evecs.set_row(3, {2.46562766e-01, -5.26100478e-04,  1.48523673e-01, 1.75533836e-01});

    ASSERT_TRUE(mat.real().nearly_equal(evecs, 1e-7));
}
