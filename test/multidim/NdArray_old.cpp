...
#include "src/core/multidim/NdArray_old.h"

TEST(NdArray_old, CorrectMapping) {
    NdArray_old<double, 3> array(2, 4, 3);
...
/*
TEST(NdArray_old, SubArrays) {
    NdArray_old<double, 4> array(2, 4, 3, 7);
...
TEST(NdArray_old, VectorCase) {
    NdArray_old<double, 1> array(8);
