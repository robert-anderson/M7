...
defs::inds BitfieldNew::setinds() const {
    return BitfieldSetEnumerator(*this).enumerate();
}

defs::inds BitfieldNew::clrinds() const {
    return BitfieldClrEnumerator(*this).enumerate();
}
