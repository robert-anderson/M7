...
Hamiltonian::Hamiltonian(const size_t &nelec, const size_t &nsite, bool spin_conserving, bool complex_valued):
m_nelec(nelec), m_nsite(nsite), m_spin_conserving(spin_conserving), m_complex_valued(complex_valued){}
