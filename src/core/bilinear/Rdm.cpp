...
Rdm::Rdm(const fciqmc_config::Bilinear &opts, size_t ranksig, size_t nsite, size_t nelec, size_t nvalue) :
...
Rdms::Rdms(const fciqmc_config::Bilinear &opts, defs::inds ranksigs, size_t nsite, size_t nelec) :
