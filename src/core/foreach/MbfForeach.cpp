...
void mbf_foreach::frm::General::Foreach::body(const foreach_virtual::rtnd::inds_t &value, size_t iiter) {
...
void mbf_foreach::frm::Spins::Foreach::body(const foreach_virtual::rtnd::inds_t &value, size_t iiter) {
...
void mbf_foreach::frm::Ms2Conserve::BetaForeach::body(const foreach_virtual::rtnd::inds_t &value, size_t iiter) {
    m_context.m_mbf->put_spin_channel(1, false);
    m_context.m_mbf->set(m_context.m_mbf->m_nsite, value);
    m_context.body();
}

void mbf_foreach::frm::Ms2Conserve::AlphaForeach::body(const foreach_virtual::rtnd::inds_t &value, size_t iiter) {
