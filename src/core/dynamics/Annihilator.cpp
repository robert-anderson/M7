...
void
Annihilator::annihilate_row(const size_t &dst_ipart, const fields::mbf_t &dst_mbf, const defs::wf_t &delta_weight,
...
Annihilator::handle_dst_mbf_block(SpawnTableRow &block_start, SpawnTableRow &current, const defs::wf_t &total_delta,
    ...
    annihilate_row(0, block_start.m_dst_mbf, total_delta, allow_initiation, irow_store);
