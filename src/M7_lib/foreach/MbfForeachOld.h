...
#ifndef M7_MBFFOREACHOLD_H
#define M7_MBFFOREACHOLD_H
...
namespace mbf_foreach_old {
     ...
     */
    struct MbfForeachOld {
        const BasisData m_bd;

        MbfForeachOld(BasisData bd) : m_bd(bd) {}
        MbfForeachOld(const MbfForeachOld &other) : m_bd(other.m_bd) {}
        virtual ~MbfForeachOld(){}
    ...
    class Base : public MbfForeachOld {
    ...
    public:
        Base(BasisData bd, body_fn_t body_fn = {}, field_t *mbf = nullptr) :
                MbfForeachOld(bd), m_mbf_internal(bd), m_mbf(mbf ? mbf : &m_mbf_internal), m_body_fn(std::move(body_fn)) {}
    ...
    namespace frm {
        ...
        class Base : public mbf_foreach_old::Base<defs::Frm> {
        public:
            static constexpr size_t mbf_ind = defs::Frm;
            Base(size_t nsite, body_fn_t body_fn = {}, field_t *mbf = nullptr);

            Base(const mbf_foreach_old::frm::Base &other, field_t *mbf);
        };
    ...
    namespace bos {
        ...
        class Base : public mbf_foreach_old::Base<defs::Bos> {
        public:
    ...
    namespace frm_bos {
        ...
        class Base : public mbf_foreach_old::Base<defs::FrmBos> {
        public:
            static constexpr size_t mbf_ind = defs::FrmBos;
            Base(BasisData bd, body_fn_t body_fn = {}, field_t *mbf = nullptr) :
                    mbf_foreach_old::Base<defs::FrmBos>(bd, std::move(body_fn), mbf) {}
    ...
    class PairBase : public MbfForeachOld {
    public:
        PairBase(BasisData bd): MbfForeachOld(bd){}
        PairBase(const MbfForeachOld& other): MbfForeachOld(other){}
        virtual ~PairBase(){}
