...
public:
     ...
     */
    void annihilate_row(uint_t dst_ipart, const field::Mbf &dst_mbf, wf_t delta_weight, uint_t dst_shift_space,
     ...
     */
    void handle_dst_block(Spawn &block_begin, Spawn &next_block_begin, wf_t total_delta, uint_t min_dst_shift_space, Walker& dst_walker);
