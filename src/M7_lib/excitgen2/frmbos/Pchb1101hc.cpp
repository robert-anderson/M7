...
Pchb1101hc::Pchb1101hc(const FrmBosHam &h, PRNG &prng) :
        FrmBosExcitGen2(h, prng, {exsig_utils::ex_1101, exsig_utils::ex_1110},"precomputed heatbath"),
        m_pick_n_given_pq(h.m_bd.m_nspinorb*h.m_bd.m_nspinorb, h.m_bd.m_nmode) {
    const auto nmode = m_h.m_bd.m_nmode;
...
bool Pchb1101hc::draw_frmbos(const size_t &exsig, const field::FrmBosOnv &src,
    ...
    if (!UniformSingles2::draw_spin_conserve_fn(m_prng, src.m_frm, prob, conn.m_frm)) return false;
