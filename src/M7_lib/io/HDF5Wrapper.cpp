...
hdf5::AttributeWriterBase::AttributeWriterBase(hid_t parent_handle, std::string name, const defs::ivec_t &shape,
                                               hid_t h5type) :
...
defs::ivec_t hdf5::GroupReader::get_dataset_shape(std::string name) {
...
hdf5::NdDistListWriter::NdDistListWriter(hid_t parent_handle, std::string name, const defs::ivec_t &item_dims,
...
hdf5::NdDistListBase::NdDistListBase(hid_t parent_handle, std::string name, const defs::ivec_t &item_dims, const size_t &nitem,
