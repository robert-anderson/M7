...
size_t EbdumpFileReader::ranksig(const defs::inds_t &inds) const {
...
void EbdumpFileReader::convert_inds(defs::inds_t &inds) {
...
bool EbdumpFileReader::next(defs::inds_t &inds, defs::ham_t &v) {
