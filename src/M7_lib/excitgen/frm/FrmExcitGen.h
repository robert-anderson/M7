...
struct FrmExcitGen : ExcitGen {
    ...
    FrmExcitGen(const FrmHam& h, PRNG& prng, defs::uintv_t exsigs, std::string description);
...
public:
    FrmLatticeExcitGen(const FrmHam& h, PRNG& prng, defs::uintv_t exsigs, std::string description):
