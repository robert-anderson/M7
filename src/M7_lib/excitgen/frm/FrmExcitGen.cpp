...
FrmExcitGen::FrmExcitGen(const FrmHam &h, PRNG &prng, defs::uintv_t exsigs, std::string description) :
...
bool FrmExcitGen::draw_frmbos(size_t exsig, const field::FrmBosOnv &src,
                              defs::prob_t &prob, conn::FrmBosOnv &conn) {
    return draw_frm(exsig, src.m_frm, prob, conn.m_frm);
}

bool FrmExcitGen::draw_h_frm(size_t exsig, const field::FrmOnv &src, defs::prob_t &prob,
...
bool FrmExcitGen::draw_h_frmbos(size_t exsig, const field::FrmBosOnv &src, defs::prob_t &prob,
