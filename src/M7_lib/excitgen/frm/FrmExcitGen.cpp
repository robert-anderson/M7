...
bool FrmExcitGen::draw_h_frm(uint_t exsig, const field::FrmOnv &src, defs::prob_t &prob,
...
bool FrmExcitGen::draw_h_frmbos(uint_t exsig, const field::FrmBosOnv &src, defs::prob_t &prob,
