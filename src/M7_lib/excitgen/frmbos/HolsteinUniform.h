...
namespace exgen {
    ...
    struct HolsteinUniform : FrmBosExcitGen {
        ...
        HolsteinUniform(const FrmBosHam& h, PRNG& prng, OpSig exsig);
    ...
    struct HolsteinUniform0010 : HolsteinUniform {
        ...
        HolsteinUniform0010(const FrmBosHam& h, PRNG& prng): HolsteinUniform(h, prng, opsig::c_0010){}
    ...
    struct HolsteinUniform0001 : HolsteinUniform {
        ...
        HolsteinUniform0001(const FrmBosHam& h, PRNG& prng): HolsteinUniform(h, prng, opsig::c_0001){}
