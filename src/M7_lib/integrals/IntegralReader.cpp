...
Hdf5IntegralReader::Hdf5IntegralReader(const FcidumpInfo& info, Hdf5IntegralReader::KeyNames names) :
        ...
        m_indices_2e(m_reader, m_names.m_2e_inds, mpi::i_am_root(mpi::SharedMemory)),
        m_values_2e(hdf5::DatasetLoader::load_vector<ham_comp_t>(m_reader, m_names.m_2e_values, mpi::i_am_root(mpi::SharedMemory))),
        m_indices_1e(m_reader, m_names.m_1e_inds, mpi::i_am_root(mpi::SharedMemory)),
        m_values_1e(hdf5::DatasetLoader::load_vector<ham_comp_t>(m_reader, m_names.m_1e_values, mpi::i_am_root(mpi::SharedMemory))) {
