...
size_t lattice::OrthoTopology::isite_adj(const defs::uintv_t &inds, size_t idim, size_t value) const {
...
size_t lattice::NullTopology::isite_adj(const defs::uintv_t &/*inds*/, size_t /*idim*/, size_t /*value*/) const {
    return ~0ul;
}
