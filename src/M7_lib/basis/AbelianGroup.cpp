...
AbelianGroupMap::AbelianGroupMap(AbelianGroup grp, defs::ivec_t site_irreps) :
...
AbelianGroupMap::AbelianGroupMap(size_t nsite) : AbelianGroupMap({}, defs::ivec_t(nsite, 0)){}
