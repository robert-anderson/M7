...
namespace sparse {
    ...
    public:
        ...
        void add(const size_t &irow, const defs::uintv_t &icols);

        void insert(const size_t &irow, const defs::uintv_t &icols);

        bool empty() const;

        bool empty(const size_t& irow) const;

        const defs::uintv_t &operator[](const size_t &irow) const;
    ...
    public:
        ...
        void add(const size_t &irow, const defs::uintv_t &icols, const std::vector<T> &vs) {
        ...
        void insert(const size_t &irow, const defs::uintv_t &icols, const std::vector<T> &vs) {
            REQUIRE_EQ(icols.size(), vs.size(), "must have same number of column indices and values");
        ...
        std::pair<const defs::uintv_t &, const std::vector<T> &> operator[](const size_t &irow) const {
