...
struct Bilinears {
    ...
    //const defs::ivec_t m_specmom_exsigs;
...
private:
     ...
     */
    static defs::ivec_t parse_exsigs(const std::vector<std::string> &strings) {
        defs::ivec_t out;
...
public:
    ...
    Bilinears(const conf::AvEsts &opts, defs::ivec_t rdm_ranksigs, defs::ivec_t specmom_exsigs,
