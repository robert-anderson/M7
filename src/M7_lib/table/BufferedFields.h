...
namespace buffered {
    ...
    struct BosOnv : BufferedField<field::BosOnv> {
        ...
        BosOnv(size_t nmode, size_t occ_cutoff=sys::bos::c_max_bos_occ) : BosOnv(sys::bos::Basis(nmode, occ_cutoff)){}
    ...
    struct FrmBosOnv : BufferedField<field::FrmBosOnv> {
        ...
        FrmBosOnv(size_t nsite, size_t nmode, size_t bos_occ_cutoff=sys::bos::c_max_bos_occ):
