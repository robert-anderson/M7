...
namespace mbf {
    ...
    void set_from_def_array(field::FrmOnv &mbf, const std::vector<uintv_t> &def, uint_t idef);

    void set_from_def_array(field::BosOnv &mbf, const std::vector<uintv_t> &def, uint_t idef);
