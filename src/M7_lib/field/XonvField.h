...
struct FrmXonvField : XonvField<FrmOnvField> {
    ...
    FrmXonvField &operator=(const std::pair<defs::ivec_t, defs::ivec_t> &inds) {
        m_ket = inds.first;
        m_bra = inds.second;
        return *this;
    }
...
struct BosXonvField : XonvField<BosOnvField> {
    ...
    BosXonvField &operator=(const std::pair<defs::ivec_t, defs::ivec_t> &inds) {
        m_ket = inds.first;
        m_bra = inds.second;
        return *this;
    }
...
struct FrmBosXonvField : XonvField<FrmBosOnvField> {
    ...
    typedef std::pair<defs::ivec_t, defs::ivec_t> pair_t;
